class PitcherStats{
    ...
    constructor(pitcher) {
        this.matchupList = pitcher.pitcherMatchups;
        this.pitcherId = pitcher.pitcherId;
        this.firstName = pitcher.firstName;
        this.lastName = pitcher.lastName;
        ...
        this.calcBasicStats(pitcher.pitcherMatchups);
    ...
    getSlugging(){
        ...
        return (totalBases / this.countAtBats()).toFixed(3).toString();
    }

    getOnBase(){
        const onBase = this.countHits() + this.walks + this.hitByPitch;
        return (onBase / this.countPlateAppearances()).toFixed(3).toString();
    }

    getAverage(){
        return (this.countHits() / this.countAtBats()).toFixed(3).toString();
    }
}
